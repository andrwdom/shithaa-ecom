      ...
      <main className="flex-1 max-w-3xl mx-auto px-4 py-12 text-gray-900 bg-white rounded-xl shadow-md mt-8 mb-8">
        ...
        <div className="space-y-6 text-base leading-relaxed">
          <ol className="list-decimal pl-6 space-y-2">
            ...
            <li><b>Contact Us</b><br/>If you have any questions or concerns about this Privacy Policy, please contact us at:<br/>Email: <a href="mailto:info.shithaa@gmail.com" className="underline">info.shithaa@gmail.com</a><br/>Instagram: <a href="https://www.instagram.com/shithaa.in" className="underline">@shithaa.in</a></li>
          </ol>
        </div>
      </main>
    </div>
