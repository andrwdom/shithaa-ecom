  ...
  return (
    <div className="bg-gray-50 min-h-screen flex flex-col">
      <main className="flex-1 max-w-3xl mx-auto px-4 py-12 text-gray-900 bg-white rounded-xl shadow-md mt-8 mb-8">
        ...
        <Head>
          <title>Privacy Policy | Shitha Clothing</title>
          <meta name="description" content="Read the Privacy Policy for Shitha Clothing. Learn how we collect, use, and protect your data." />
          <meta name="robots" content="index, follow" />
        </Head>
        <h1 className="text-3xl font-bold mb-6 font-serif">Privacy Policy</h1>
        <div className="space-y-6 text-base leading-relaxed">
          <ol className="list-decimal pl-6 space-y-2">
            <li><b>Introduction</b><br/>At Shitha clothing we respect your privacy and are committed to protecting the personal information you share with us. This Privacy Policy explains how we collect, use, and safeguard your data when you visit or make a purchase from our website.</li>
