  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        ...
        const apiUrl = (process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5000') + '/api/products/' + productId;
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <CheckoutPromptModal
        ...
        onViewCart={() => {
          ...
          // Optionally open cart sidebar if you want
          // openCartSidebar();
          window.location.href = "/cart";
        }}
        onCheckout={() => {
          setIsCheckoutPromptOpen(false);
          // Optionally go to checkout page
