...
export default function CategoryPage() {
  ...
  useEffect(() => {
    const fetchCategoryProducts = async () => {
      try {
        ...
        const apiUrl = (process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5000') + '/api/products?category=' + encodeURIComponent(categorySlug) + '&sortBy=createdAt&limit=16';
  ...
  return (
    <PageLoading loadingMessage="Loading Collection..." minLoadingTime={1500}>
