...
export default function SizeSelectionSidebar({
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className="fixed inset-x-0 bottom-0 md:right-0 md:top-0 md:left-auto md:w-96 md:inset-y-0 bg-white z-55 transform transition-transform duration-300 md:shadow-2xl">
