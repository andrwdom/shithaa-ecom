...
export default function CartSidebar() {
  ...
  return (
    <React.Fragment>
      {/* Backdrop */}
      <div className="fixed inset-0 bg-black/50 z-70" onClick={closeCartSidebar} />
      {/* Sidebar */}
      <div className="fixed right-0 top-0 h-full w-96 bg-white shadow-2xl z-80 transform transition-transform duration-300 flex flex-col">
        {/* Header */}
